...
const SignIn = () => {
  ...
  return (
    <div className='mx-3 md:mx-6 lg:mx-12'>
      <h1 className='text-2xl text-center mt-6 font-semibold'>Sign In</h1>
      ...
      <div className="lg:flex mt-8 lg:space-x-20 space-y-6 items-center">
        ...
        <div className="lg:w-[50%] ">
          <form
            ...
            <input
              type="email"
              className="w-full py-2 text-sm md:text-md lg:text-md text-gray-700 bg-white border-gray-300 rounded-sm transition ease-in-out duration-300"
              id="email"
              value={email}
